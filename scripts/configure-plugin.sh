...
usage() {
  cat <<'EOF'
Configure the Azure DevOps Codex plugin for this local machine.
...

{
  ...
  printf '# Generated by scripts/configure-plugin.sh. Do not commit this file.\n'
...
"$repo_root/scripts/validate-plugin.sh"
